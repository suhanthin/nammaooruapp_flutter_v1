...
import 'BalanceDetailsPage.dart';
...
class MemberProfile extends StatefulWidget {
  ...
  MemberProfile({required this.memberData});
...
class _MemberProfileState extends State<MemberProfile> {
  ...
  void _BalanceDetails() async {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => BalanceDetailsPage(
          memberData: widget.memberData,  // Pass memberData here
        ),
      ),
    );
  }
        ...
        leading: IconButton(
          ...
          onPressed: () {
            Navigator.push(
              ...
              MaterialPageRoute(
                builder: (context) =>
                    MembersList(pageTitle: 'Members list', pageType: 'all'),
              ),
            );
          },
        ),
                                    ...
                                    Expanded(
                                      child: Column(
                                        children: [
                                                  ...
                                                  FractionalTranslation(
                                                    translation: Offset(2.5, 0),
                                                      ...
                                                      onPressed: () {
                                                        Navigator.push(
                                                          context,
                                                          MaterialPageRoute(builder: (context) => Addmembers(memberData: widget.memberData, pageaction: 'edit')),
                                                        );
                                                      },
                                                    ),
                                                  ),
                                          ...
                                          Visibility(
                                            visible:  widget.memberData.containsKey("jobProfessional") &&  widget.memberData["jobProfessional"] != 'null',
                                            child: Container(
                                              child: Column(
                                                children: <Widget>[
                                                  Padding(
                                                    ...
                                                    child: Align(
                                                      child: Row(
                                                        children: [
                                                          ...
                                                          SizedBox(width: 10),
                                                          Text(capitalize(widget.memberData["jobProfessional"].toString().toLowerCase())),
                                                        ],
                                                      ),
                                                    ),
                                                  ),
