...
class ThemeHelper{
  ...
  InputDecoration textInputDecoration([String lableText="", String hintText = "",myIcon]){
  ...
  InputDecoration textInputDecorationNoicon([String lableText="", String hintText = "",myIcon]){
    return InputDecoration(
      //prefixIcon: myIcon,
      labelText: lableText,
      hintText: hintText,
  ...
  InputDecoration textInputDecorationicon([String lableText="", String hintText = "",myIcon]){
    return InputDecoration(
      prefixIcon: myIcon,
      labelText: lableText,
      hintText: hintText,
